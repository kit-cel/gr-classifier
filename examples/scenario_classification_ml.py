...
# Generated: Sun Nov 19 00:51:13 2017
##################################################
...
class scenario_classification_ml(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_raster_sink_x_0_1_0_0_win, 0, 2, 1, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_raster_sink_x_0_1_0_win, 0, 1, 1, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_raster_sink_x_0_0_0_win, 1, 2, 1, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_raster_sink_x_0_0_win, 1, 1, 1, 1)
        ...
        self.fft_vxx_1 = fft.fft_vcc(64, True, (window.blackmanharris(64)), True, 1)
        self.fft_vxx_0 = fft.fft_vcc(nfft, True, (window.blackmanharris(nfft)), True, 1)
        self.classifier_np_average_vf_vf_0 = classifier.np_average_vf_vf()
        ...
        self.classifier_energy_detection_vcf_0 = classifier.energy_detection_vcf(nfft, 1, threshold_delta)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/cuervo/thesis/data/final_pu/no_dc/scn_9_snr_0.dat', True)
        ...
        self.connect((self.blocks_nlog10_ff_0, 0), (self.classifier_np_average_vf_vf_0, 0))
        ...
        self.connect((self.classifier_np_average_vf_vf_0, 0), (self.classifier_dl_class_0, 0))
        self.connect((self.classifier_np_average_vf_vf_0, 0), (self.classifier_dl_class_0_0, 0))
        self.connect((self.classifier_np_average_vf_vf_0, 0), (self.classifier_dl_class_0_0_0, 0))
